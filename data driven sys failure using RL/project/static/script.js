...
async function refresh() {
  ...
  document.getElementById('failureType').innerText = metrics.failure_type || 'No failure detected';
  document.getElementById('affectedApp').innerText = metrics.affected_app || 'None';
  document.getElementById('solutionText').innerText = metrics.solution || 'System stable';

  // Alert if failure
  if (metrics.failure_type && metrics.failure_type !== 'Normal') {
    showAlert(`Failure: ${metrics.failure_type} in ${metrics.affected_app}`);
  }
